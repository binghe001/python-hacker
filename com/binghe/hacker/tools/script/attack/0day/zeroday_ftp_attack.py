...
# Date: 2019/2/14
# Created by 冰河
# Description 0day漏洞利用脚本， 需要配合使用FreeFloat FTP,
#             FreeFloat FTP下载地址为：https://download.csdn.net/download/l1028386804/10956671
#
#             用法： python zeroday_attack.py 192.168.175.130 PWND
#
#             另附FreeFloat FTP 漏洞利用程序：
